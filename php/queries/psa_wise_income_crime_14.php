#!/usr/local/bin/php
<?php
$query = "select A.sumtot A, A.psa_id B, average_family_income C from (select count(*) sumtot , psa_id from crime group by psa_id) A, psa where psa.psa_id=A.psa_id order by A.psa_id";

/////////////////////////////////////////////////////////////PSA and income
/*
select A.sumtot A, A.psa_id B, average_family_income C 
from (select count(*) sumtot , psa_id 
	  from crime group by psa_id) A, psa 
where psa.psa_id=A.psa_id order by A.psa_id
