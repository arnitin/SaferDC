...
$count   = 0;
$prev    = "zzzz";  /* Setting prev to a value that will never come as a reult from the database */ 
$counter = -12;
while($row = oci_fetch_array($statement,OCI_BOTH)){

	if ($prev != $row['A'])   /* A is offence_type */ 
		{
		$prev = $row['A'];
		$counter = $counter + 12;
...
$final = array("title"=>"Crime Rate", "type"=>"line","yLabel"=>"Number of crimes","xLabel"=>"Months");
