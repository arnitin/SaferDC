...
/////////////////////////////////////////////////////////////highest incidence of crimes at a place on monday
 /*
...
where tabl.val = (SELECT MAX(A) FROM (select latitude,longitude,to_char(report_date,'D') Z,count(*) A
from crime 
...
*/
	...
	while( ($row = oci_fetch_array($statement,OCI_BOTH)) && $counter < 10 ) {
		...
		$tempArray3[$counter] = /*$row[0]." '".*/$row['C'] . " crimes on Fridays here" ;//count
		$counter++;
	}
	//$final = array();
